...
namespace ShoppeFake.Application.Interfaces
{
    ...
    {
        Task<bool> SendV1Async(string message, CancellationToken cancellationToken = default);
        Task<bool> SendV2Async(string conversationId, string message, CancellationToken cancellationToken = default);
