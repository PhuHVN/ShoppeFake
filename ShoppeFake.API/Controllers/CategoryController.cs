...
namespace ShoppeFake.API.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        [SwaggerOperation(summary: "Admin - Create a new category", description: "Creates a new product category with the provided details.")]
        ...
        [HttpGet("{id}")]
        [SwaggerOperation(summary: "Public - Get category by ID", description: "Retrieves the details of a product category using its unique identifier.")]
        ...
        [HttpGet]
        [SwaggerOperation(summary: "Public - Get all categories", description: "Retrieves a paginated list of all product categories.")]
        ...
        [HttpPut("{id}")]
        [Authorize(Roles = "Admin")]
        [SwaggerOperation(summary: "Admin - Update a category", description: "Updates the details of an existing product category.")]
        ...
        [HttpDelete("{id}")]
        [Authorize(Roles = "Admin")]
        [SwaggerOperation(summary: "Admin - Delete a category", description: "Deletes a product category using its unique identifier.")]
